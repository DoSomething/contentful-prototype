...
class ReferralPageController extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        return response()->view('app', [
            ...
            'metadata' => [
                'title' => $title,
                'description' => config('feature-flags.refer_friends_v2') ? 'Make an impact with your friend by signing up for a DoSomething volunteer campaign.' : 'Make an impact with your friend by completing one of DoSomething\'s volunteer campaigns. (You\'ll both increase your chances of winning the campaign scholarship!)',
