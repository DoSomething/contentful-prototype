              ...
              <div className="grid-narrow">
                <div className="my-6">
                  ...
                  <div className="my-6">
                    <h3>FAQ</h3>
                    <h4>
                      1. Can I increase my chances of winning the scholarship if
                      I already have a DoSomething account?
                    </h4>
                    <p>
                    ...
                    <p className="italic">
                      ...
                      hundreds of campaigns to choose from (but only the one
                      above is offering the reward right now). Let’s do this!
                    </p>
                  </div>
                </div>
              </div>
